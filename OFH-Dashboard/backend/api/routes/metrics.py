...
def get_metrics():
    ...
    try:
        ...
        with get_session_context() as session:
            ...
            # Get conversation analytics for conversation metrics
            ...
            metrics_data = {
                ...
                'conversation_metrics': {
                    'total_sessions': conversation_data.get('summary', {}).get('total_conversations', 0),
                    'active_sessions': conversation_data.get('summary', {}).get('active_conversations', 0),
                    'completed_sessions': conversation_data.get('summary', {}).get('total_conversations', 0) - conversation_data.get('summary', {}).get('active_conversations', 0),
